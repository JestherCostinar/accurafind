                    ...
                    <div class="col-lg-4 col-md-6" data-aos="flip-left">
                        <div class="card mb-4" style="width: 21rem; ">
                            <div class="card-header" style="background: #2b929d">
                                <a href="<?php echo $row['LINK']; ?>" target="_blank"><img class="card-img-top my-2" src="admin/superadmin/company/company_image/<?php echo $row['COMPANY_IMAGE']; ?>" height="100px" alt="Card image cap" style="padding: 0 1rem; border-radius: 30px;"></a>
                            </div>
