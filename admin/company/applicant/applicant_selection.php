                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td align="center" width="5%">
                                            ...
                                            <a href="action.php?regisid=<?php echo $row['regid']; ?>&applicantid=<?php echo $row['appid']; ?>&position=<?php echo $row['OCCUPATION_TITLE']; ?>&jobStatus=<?php echo $row['jobstat']; ?>" class="btn btn-outline-success btn-sm">
