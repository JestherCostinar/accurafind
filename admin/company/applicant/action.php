        ...
        <main>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="application_selection.php">Applicant Under interview</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="p-5">
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Type of Employement:<mark style="color: #ff3939; background: #fff"> (Only for accepting applicants)</mark></label>
                                    <select class="form-control input-sm" name="employment">
                                        <option value="None">--</option>
                                        <option>Casual Employment</option>
                                        <option>Probationary Employment</option>
                                ...
                                <div class="form-row">
                                    <div class="col-md-3 mb-3">
                                        <label>Work Start <mark style="color: #ff3939; background: #fff"> (Only for accepting applicants)</mark></label>
                                        <input type="date" class="form-control" name="dateFrom" value="<?php echo date('Y-m-d'); ?>">
                                    </div>
                                </div>

                                <p>Requirements
                                    <mark style="color: #ff3939; background: #fff"> (Only for accepting applicants)</mark>
                                </p>
                                <div class="form-row">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="BIR" id="requirement" name="requirement[]">
                                        <label class="form-check-label">
                                            BIR
                                        </label>

                                    </div>
                                    <div class="form-check" style="margin-left: 305px;">
                                        <input class="form-check-input" type="checkbox" value="Birth Certificate " id="requirement" name="requirement[]">
                                        <label class=" form-check-label">
                                            Birth Certificate
                                        </label>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="SSS" id="requirement" name="requirement[]">
                                        <label class="form-check-label">
                                            SSS
                                        </label>

                                    </div>
                                    <div class="form-check" style="margin-left: 300px">
                                        <input class="form-check-input" type="checkbox" value="NBI Clearance" id="requirement" name="requirement[]">
                                        <label class=" form-check-label">
                                            NBI Clearance
                                        </label>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="Pag-Ibig" id="requirement" name="requirement[]">
                                        <label class="form-check-label">
                                            Pag-Ibig
                                        </label>

                                    </div>
                                    <div class="form-check " style="margin-left: 260px;">
                                        <input class="form-check-input" type="checkbox" value="PhilHealth" id="requirement" name="requirement[]">
                                        <label class=" form-check-label">
                                            PhilHealth
                                        </label>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="Diploma & Transcript of Record" id="requirement" name="requirement[]">
                                        <label class="form-check-label">
                                            Diploma & Transcript of Record
                                        </label>
                                ...
                                <div class="form-group">
                                    <label for="app_score" class="col-form-label mt-3">Other Requirements:</label>
...
if (isset($_POST['submit_score'])) {
    ...
    if ($a_status == "Accepted") {
        $remarkMessage = "Congratulations! You have been hired; please see below for additional company requirements that you need to accomplish: $concat $other_req. You can start in $new_date. We are excited to work with you, and Welcome to the company!";
        $insert_employee = mysqli_query($conn, "INSERT INTO tblemployee(FNAME, LNAME, MNAME, ADDRESS, CITY, STATE, ZIP, CONTACTNO, EMAIL, POSITION, EMPLOYMENT, OBJECTIVE, DATEHIRED, COMPANYID, APPLICANTID) VALUES ('$fname', '$lname', '$mname', '$address', '$city', '$state', '$zip', '$emp_contact', '$email', '$position', '$employment', '$objective', '$date', '$companyid', '$applicantid')");
        $emailFormat = '<p>Hello, Mr/Ms. <b>' . $fullname . ',</b><br><br>' . 'Thank you for alloting your time to talk about the job position of ' . $position .
            '. It was a pleasure getting to meet you, and we pressume you\'d be a good fit for this role. Congratulations! You have been hired; these is the requirements that you need to accomplish: '
            . $concat . $other_req . '. You can start in ' . $new_date . '<br>' . 'We are excited to work with you, and Welcome to the company! We are looking forward to hearing back from you.' . '<br><br>' . 'Thanks Again,' . '<br>' . $hrname . '.</p>';
        if ($insert_employee) {
            $update_applicant_status = mysqli_query($conn, "UPDATE tblapplicant SET STATUS = 'Employed' WHERE applicantid = '$applicantid'");
        }
    }
    ...
    if ($remarkMessage) {
        ...
        echo ("<script>window.location = 'applicant_selection.php';</script>");
    } else {
