                ...
                <div>
                    <div class="activity-card">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pr-3">
                            <h3 class="mb-0">List of Not Qualified Applicant</h3>


                            <form action="not_qualified.php" method="POST"">
                            ...
                            <a type="submit" name="print_emp" class="btn btn-primary ml-2 float-right" href="print_notqualified.php?jobname=<?php echo $jobtitle ?>" target="_blank"><span class="ti-printer"></a>
