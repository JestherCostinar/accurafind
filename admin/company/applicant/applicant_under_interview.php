                ...
                <div>
                    <div class="activity-card">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pr-3">
                            <h3 class="mb-0">List of Applicant Scheduled for Interview</h3>


                            <form action="applicant_under_interview.php" method="POST"">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['INTERVIEW_SCORE']; ?></td>
                                        <td align="center">
                                            <a href="score.php?regisid=<?php echo $row['regid']; ?>&applicantid=<?php echo $row['appid']; ?>&position=<?php echo $row['OCCUPATION_TITLE']; ?>&jobStatus=<?php echo $row['jobstat']; ?>" class="btn btn-outline-primary btn-sm">
                                                <span class="">score</span>
                                            </a>
                                            <a href="first_interview_action.php?regisid=<?php echo $row['regid']; ?>&applicantid=<?php echo $row['appid']; ?>&position=<?php echo $row['OCCUPATION_TITLE']; ?>&jobStatus=<?php echo $row['jobstat']; ?>" class="btn btn-outline-success btn-sm">
