                ...
                <div>
                    <div class="activity-card">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pr-3">
                            <h3 class="mb-0">List of Archived Applicant</h3>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td width="3    %">
                                                <a href="archieve_delete.php?regisid=<?php echo $row['regid']; ?>" class="btn btn-sm btn-outline-danger">
