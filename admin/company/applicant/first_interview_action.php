                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        <label>Screening Stage Schedule <mark style="color: #ff3939; background: #fff"> (Only for accepting applicants)</mark></label>
