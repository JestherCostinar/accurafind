        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4">
                    ...
                    <form action="applicant_joblist.php" method="get">
                        <div class="job-category-listing mb-50">
                            ...
                            <div class="single-listing">
                                ...
                                <div class="select-job-items2 mb-50">
                                    <input type="text" class="form-control" name="job_name" placeholder="Type Job here..">
                                </div> -->
                                ...
                                <div class="select-job-items2">
                                    <select name="job_category">
                                        ...
                                        <option value="Mid Level">Intermediate </option> <!-- (position that requires more experience than an entry-level job) -->
                                        <option value="Senior Level">Mid-level</option>
                                        <option value="Expert Level">Senior or executive-level</option>
                                    </select>
                                </div>
                    ...
                    <section class="featured-job-area">
                        <div class="container">
                            ...
                            if (!empty($_POST['jobtitle']) and !empty($_POST['category'])) {
                                ...
                                $query = mysqli_query($conn, "SELECT tblcompany.*, tblcategory.CATEGORY, tbljob.*, CONCAT('₱', FORMAT(salary_from, 'c'),' - ₱', FORMAT(salary_to, 'c')) AS salaries, CONCAT(age_from,' - ', age_to, ' years old') AS age_range, CONCAT(work_experience, ' years of experience') AS work_exp FROM tbljob, tblcategory, tblcompany WHERE tbljob.COMPANYID=tblcompany.COMPANYID AND tbljob.REMARKS = 'On going' AND tbljob.OCCUPATION_TITLE LIKE '%$jobtitle%' AND tblcategory.CATEGORYID = tblcompany.CATEGORYID and tblcategory.CATEGORY = '$category'");
                            } elseif (!empty($_POST['jobtitle']) and empty($_POST['category'])) {
                                $jobtitle = $_POST['jobtitle'];
                                $category = $_POST['category'];
                                $query = mysqli_query($conn, "SELECT tblcompany.*, tblcategory.CATEGORY, tbljob.*, CONCAT('₱', FORMAT(salary_from, 'c'),' - ₱', FORMAT(salary_to, 'c')) AS salaries, CONCAT(age_from,' - ', age_to, ' years old') AS age_range, CONCAT(work_experience, ' years of experience') AS work_exp FROM tbljob, tblcategory, tblcompany WHERE tbljob.COMPANYID=tblcompany.COMPANYID AND tbljob.REMARKS = 'On going' AND tbljob.OCCUPATION_TITLE LIKE '%$jobtitle%' AND tblcompany.CATEGORYID = tblcategory.CATEGORYID");
                            } elseif (empty($_POST['jobtitle']) and !empty($_POST['category'])) {
                                $jobtitle = $_POST['jobtitle'];
                                $category = $_POST['category'];
                                $query = mysqli_query($conn, "SELECT tblcompany.*, tblcategory.CATEGORY, tbljob.*, CONCAT('₱', FORMAT(salary_from, 'c'),' - ₱', FORMAT(salary_to, 'c')) AS salaries, CONCAT(age_from,' - ', age_to, ' years old') AS age_range, CONCAT(work_experience, ' years of experience') AS work_exp FROM tbljob, tblcategory, tblcompany WHERE tbljob.COMPANYID=tblcompany.COMPANYID AND tbljob.REMARKS = 'On going' AND tblcategory.CATEGORYID = tblcompany.CATEGORYID and tblcategory.CATEGORY = '$category'");
                            } elseif (empty($_POST['jobtitle']) and empty($_POST['category'])) {
                            ...
                            ?>
                                <div class="single-job-items mb-30" data-aos="fade-up">
                                    ...
                                    <div class="items-link f-right">
                                        <a href="applicant_jobdetail.php?details=<?php echo $row['JOBID']; ?>">Apply</a>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
